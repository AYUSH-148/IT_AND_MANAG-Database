...
const Sidebar = () => {
  ...
  return (
    <div className={`fixed scrollbar-none top-0 right-0 w-full sm:w-[310px] z-10 h-screen p-8 bg-white shadow-md transform transition-transform duration-300   ${isSidebarOpen ? "translate-x-0" : "translate-x-full"} overflow-y-auto`}>
      <button
        type="button"
